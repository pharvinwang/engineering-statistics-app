...
- **CDF（累積機率函數）**：事件小於等於某值的機率，例如「雨量小於 100 mm 的機率」。
...
- **百分位數 Percentile**：資料中，有多少比例會低於某個值。  
  工程用途：  
  - 設計暴雨量（如 95 百分位）  
  - 材料最小保證強度（如 5 百分位）  
- **三個常用工程分布**：
- **正態分布 Normal**： 用於誤差、材料尺寸、測量誤差。  
- **對數正態 Lognormal**： 用於非負資料，如降雨、流量、材料強度。  
- **威布爾 Weibull**： 用於風速、材料破壞機率、壽命分布。  
